...
def _migrate(db):
    migrations = {
        ...
        'books': {
            ...
            'argument_chain': "ALTER TABLE books ADD COLUMN argument_chain TEXT DEFAULT '[]'",
            'what_author_rejects': "ALTER TABLE books ADD COLUMN what_author_rejects TEXT DEFAULT '[]'",
            'intellectual_dialogues': "ALTER TABLE books ADD COLUMN intellectual_dialogues TEXT DEFAULT '[]'",
            'three_ideas_worth_reading': "ALTER TABLE books ADD COLUMN three_ideas_worth_reading TEXT DEFAULT '[]'",
            'central_thesis': "ALTER TABLE books ADD COLUMN central_thesis TEXT DEFAULT ''",
            'opening_question': "ALTER TABLE books ADD COLUMN opening_question TEXT DEFAULT ''",
        },
        'chat_messages': {
