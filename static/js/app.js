...
async function openGame(bookId) {
  ...
  content.innerHTML = `<div class="game-intro">
    ...
    <p class="muted-text">Voy a generar un mini-juego basado en este libro: un fragmento, preguntas de comprensión que te dan puntos, y preguntas de interpretación que me ayudan a conocerte mejor.</p>
...
async function answerGame(idx) {
  ...
  if (q.type === 'comprehension') {
    ...
    feedback.innerHTML = `<strong>Gracias por compartir tu perspectiva 🧠</strong> Esto me ayuda a entenderte mejor.`;
  }
